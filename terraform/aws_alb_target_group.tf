resource "aws_alb_target_group" "brewgorithm_read" {
  name = "Brewgorithm-API-Read-${var.name}"
...
resource "aws_alb_target_group" "brewgorithm_write" {
  name = "Brewgorithm-API-Write-${var.name}"
